...
import type { CuratedPodcast, Episode, Source, UserCurationProfileStatus, UserCurationProfileWithRelations } from "@/lib/types"
...
const DUMMY_CURATED_PODCASTS: CuratedPodcast[] = [
	{
		...
		isActive: true,
		createdAt: new Date(),
		ownerUserId: "user_2gXwLd20u8wK51Y5YjBf02002",
	},
	{
		id: "pod2",
		name: "The Vergecast",
...
const DUMMY_SOURCES: Source[] = [
	{
		...
		description: "Educational podcast about technology and science",
...
const DUMMY_EPISODES: Episode[] = [
	{
		...
		podcastId: DUMMY_SOURCES[0].id,
		userProfileId: DUMMY_USER_CURATION_PROFILE.id,
		bundleId: null,
		weekNr: new Date(),
		podcast: DUMMY_SOURCES[0],
		userProfile: DUMMY_USER_CURATION_PROFILE,
	},
	{
		id: "episode2",
		...
		podcastId: DUMMY_SOURCES[1].id,
		userProfileId: DUMMY_USER_CURATION_PROFILE.id,
		bundleId: null,
		weekNr: new Date(new Date().setDate(new Date().getDate() - 7)),
		podcast: DUMMY_SOURCES[1],
		userProfile: DUMMY_USER_CURATION_PROFILE,
	},
]
