...
module.exports = {
	...
	theme: {
		extend: {
			...
			backgroundImage: {
				"content-gradient":
					"radial-gradient(ellipse 80% 70% at 50% -40%, rgba(21, 99, 131, 0.9), rgb(18, 18, 20)), radial-gradient(ellipse 80% 50% at 50% -20%, rgba(0, 24, 51, .6), rgba(24, 23, 26, 0.3))",
			...
			boxShadow: {
				glass:
					"0 10px 12px 0 oklch(0 0 none / 0.09), 0 1px 3px lch(5.81% 3.47 304.61 / 0.266), inset 0 1px 1px #4cfbf561, 3px 18px 17px #0000001d, 0 1px 3px #0000001a, inset -100px 10px 200px -1px oklch(0.45 0.1749 288.98 / 0.41)",
