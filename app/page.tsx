...
import { UilArrowRight, UilCheckCircle, UilClock, UilFile, UilPlay, UilSetting, UilStar, UilBolt, UilBrain, UilVolumeUp, UilSearch, UilTarget } from "@iconscout/react-unicons"
...
export default async function LandingPage() {
	...
	const features = [
		{
			icon: <UilBrain className="w-6 h-6" />,
		...
		{
			icon: <UilVolumeUp className="w-6 h-6" />,
		...
		{
			icon: <UilSearch className="w-6 h-6" />,
		...
		{
			icon: <UilTarget className="w-6 h-6" />,
		...
		{
			icon: <UilBolt className="w-6 h-6" />,
