...
import { Bell, Check, Trash2, Clock, Play, Calendar } from "lucide-react"
      ...
      <div className={styles.header}>
        <div className={styles.headerContent}>
          <div className={styles.titleSection}>
            ...
            {unreadCount > 0 && (
              <Badge className={styles.unreadBadge}>{unreadCount}</Badge>
            )}
          </div>
        ...
        {notifications.length === 0 ? (
          ...
          <div className={styles.notificationsList}>
            {notifications.map((notification) => (
              <Card
                key={notification.id}
                className={`${styles.notificationCard} ${!notification.isRead ? styles.unreadCard : ''}`}
              >
                <CardHeader className={styles.cardHeader}>
                  <div className={styles.notificationHeader}>
                    ...
                    <div className={styles.notificationInfo}>
                      ...
                      <CardTitle className={styles.notificationTitle}>
