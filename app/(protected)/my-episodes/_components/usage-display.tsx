...
export function UsageDisplay() {
	...
	return (
		<div className="bg-[#060506] w-full px-4  mx-0  border-b border-b-[#f4e5f725] lg:border-l lg:border-l-[#f4e5f725] lg:border-b-none rounded-none sm:px-5 py-2 md:p-8 lg:w-[300px]">
