    ...
    <div className="container mx-auto p-6 max-w-4xl space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Extract and populate duration metadata for existing audio files stored in GCS.
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Extract duration from user-generated podcast episode audio files.
              This will update all user episodes that have audio files but missing duration data.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Extract duration from regular podcast episode audio files stored in GCS.
              This will only process episodes stored in our GCS bucket, skipping external URLs.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
            ...
            <li>
              Regular episodes are processed in batches of 50 to avoid timeouts - you may need to run multiple times for large datasets
            </li>
            <li>
              The tool uses the same audio metadata extraction logic used for new episode generation
            </li>
            <li>
              Duration is extracted from WAV file headers and stored in seconds
            </li>
          </ul>
        </CardContent>
      </Card>
