		...
		<div className="wrapper mt-4">
            ...
            {!!error && (
				<div className="max-w-2xl mx-auto mt-8">
					...
					<div className="mt-6 text-center">
                        <Button asChild variant="outline"><Link href="/curated-bundles">Try Again</Link></Button>
					</div>
				</div>
			)}
            {curatedBundles.length === 0 ? (
				<div className="max-w-2xl mx-auto mt-8">
					...
					<div className="mt-6 text-center">
                        <Button asChild variant="default"><Link href="/curated-bundles">Refresh</Link></Button>
					</div>
				</div>
			) : (
