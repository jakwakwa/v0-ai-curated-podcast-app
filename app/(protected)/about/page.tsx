...
import { ArrowRight, Calendar, CheckCircle, Play, Podcast, Settings, Sparkles, Users } from "lucide-react"
...
export default function AboutPage() {
	...
	const pricingTiers = [
		...
		},
		{
			...
			price: "R99",
			duration: "per month",
			features: ["Unlimited curation profiles", "Weekly generation", "Priority support", "Advanced analytics", "Early access to new features"],
			popular: true,
		},
	]
		...
		<div className={styles.container}>
			...
			<section className={styles.hero}>
				<div className={styles.heroContent}>
					<h1 className={styles.heroTitle}>Welcome to AI Curator</h1>
					<p className={styles.heroDescription}>
						Your personal AI-powered podcast curator that creates weekly episodes tailored to your interests. Choose from hand-picked content or create your own custom curation profile.
					</p>
			...
			<section className={styles.section}>
				<div className={styles.sectionHeader}>
					...
					<p className={styles.sectionDescription}>We combine the best of human curation with AI-powered generation to deliver personalized podcast experiences that match your interests.</p>
				</div>
				...
				<div className={styles.featuresGrid}>
					{features.map((feature, index) => (
						<Card key={index} className={styles.featureCard}>
							...
							<CardContent>
								<CardDescription className={styles.featureDescription}>{feature.description}</CardDescription>
							</CardContent>
						</Card>
					))}
				</div>
			...
			<section className={styles.section}>
				<div className={styles.sectionHeader}>
					...
					<p className={styles.sectionDescription}>Getting started with AI Curator is simple. Follow these four easy steps to create your personalized podcast experience.</p>
				</div>
			...
			<section className={styles.section}>
				<div className={styles.sectionHeader}>
					...
					<p className={styles.sectionDescription}>Start with a free trial and upgrade when you're ready for unlimited access.</p>
				</div>
						...
						<Card key={tier.name} className={`${styles.pricingCard} ${tier.popular ? styles.popularCard : ""}`}>
							...
							<CardContent>
								...
								<Link href="/subscription">
									<Button className={`${styles.pricingButton} ${tier.popular ? styles.popularButton : ""}`} variant={tier.popular ? "default" : "outline"} size="lg">
			...
			<section className={styles.ctaSection}>
				<Card className={styles.ctaCard}>
					<CardContent className={styles.ctaContent}>
						<h2 className={styles.ctaTitle}>Ready to Start Your Podcast Journey?</h2>
						<p className={styles.ctaDescription}>Join thousands of users who are already enjoying personalized AI-generated podcasts.</p>
