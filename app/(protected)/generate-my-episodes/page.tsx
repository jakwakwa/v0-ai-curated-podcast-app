...
export default async function GenerateMyEpisodesPage() {
	return (
		<div className="w-full h-full min-h-[84vh] bg-[#2b2c3292] flex flex-col lg:flex-row-reverse rounded-xl sm:rounded-xl md:rounded-4xl border-2 border-[#0f171ce6] overflow-x-hidden px-0 mx-0">
