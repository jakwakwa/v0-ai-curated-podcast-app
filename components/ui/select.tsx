...
const SelectScrollUpButton = React.forwardRef<React.ElementRef<typeof SelectPrimitive.ScrollUpButton>, React.ComponentPropsWithoutRef<typeof SelectPrimitive.ScrollUpButton>>(
	({ className, ...props }, ref) => (
		<SelectPrimitive.ScrollUpButton ref={ref} className={`${styles.selectScrollButton} ${className}`} {...props}>
			<ChevronUp className={styles.selectScrollButtonSvg} />
...
const SelectScrollDownButton = React.forwardRef<React.ElementRef<typeof SelectPrimitive.ScrollDownButton>, React.ComponentPropsWithoutRef<typeof SelectPrimitive.ScrollDownButton>>(
	({ className, ...props }, ref) => (
		<SelectPrimitive.ScrollDownButton ref={ref} className={`${styles.selectScrollButton} ${className}`} {...props}>
			<ChevronDown className={styles.selectScrollButtonSvg} />
...
const SelectContent = React.forwardRef<React.ElementRef<typeof SelectPrimitive.Content>, React.ComponentPropsWithoutRef<typeof SelectPrimitive.Content>>(
	({ className, children, position = "popper", ...props }, ref) => (
		<SelectPrimitive.Portal>
			<SelectPrimitive.Content ref={ref} className={`${styles.selectContent} ${position === "popper" ? styles.selectContentPopper : ""} ${className}`} position={position} {...props}>
				<SelectScrollUpButton />
				<SelectPrimitive.Viewport className={`${styles.selectViewport} ${position === "popper" ? styles.selectViewportPopper : ""}`}>{children}</SelectPrimitive.Viewport>
...
const SelectItem = React.forwardRef<React.ElementRef<typeof SelectPrimitive.Item>, React.ComponentPropsWithoutRef<typeof SelectPrimitive.Item>>(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Item ref={ref} className={`${styles.selectItem} ${className}`} {...props}>
		<span className={styles.selectItemIndicatorSpan}>
			<SelectPrimitive.ItemIndicator>
				<Check className={styles.selectItemCheckIcon} />
			</SelectPrimitive.ItemIndicator>
		</span>
