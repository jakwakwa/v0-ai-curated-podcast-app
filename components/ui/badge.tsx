...
const badgeVariants = cva(
	"inline-flex items-center  content-center justify-center rounded border border-[#5664718E] px-3.5 py-0.5 font-normal transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 h-6 text-[0.6rem] text-center",
	{
		variants: {
			variant: {
				default:
