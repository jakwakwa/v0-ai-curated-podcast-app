...
function TabsTrigger({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.Trigger>) {
	return (
		<TabsPrimitive.Trigger
			...
			className={cn("focus-visible:border-dark  inline-flex  gap-3 flex-3  text-sm items-center justify-center font-medium  disabled:pointer-events-none disabled:opacity-20 btn-toggle", className)}
			{...props}
		/>
	);
}
