	...
	return (
		<Card className="bg-card w-full px-2 py-5 relative">
			...
			<div className="w-full flex flex-row gap-4">
				<CardHeader>
					{imageUrl ? (
						<Image src={imageUrl} alt={title} className=" h-14 w-14 md:h-22 md:w-22 border-2 m-2 max-w-22 shadow-md border-[#98CAD35C] rounded-xl object-fill" width={100} height={60} />
					) : null}
				</CardHeader>
