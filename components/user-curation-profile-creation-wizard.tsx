...
import { useUserCurationProfileStore, useSubscriptionStore } from '@/lib/stores'
...
export function UserCurationProfileCreationWizard() {
	...
	const [selectedPodcasts, setSelectedPodcasts] = useState<any[]>([]) // Use proper type if available

  const {
		createUserCurationProfile,
    isLoading,
    error,
	} = useUserCurationProfileStore()
		...
		<div className={styles.wizardContainer}>
            ...
            <h2 className={styles.stepTitle}>
					...
					{isBundleSelection ? (
						...
						<CuratedPodcastList onSelectPodcast={podcast => {
