	...
	return (
		<div className={className}>
			...
			<Card variant="bundle">
				...
				<div className="p-4 border border-muted/50 rounded-lg bg-card">
						...
						{billingHistory.length === 0 ? (
							...
							<div className="space-y-3">
								{billingHistory.map(item => (
									<div key={item.id} className="flex items-center justify-between p-3 border border-muted/50 rounded-lg">
